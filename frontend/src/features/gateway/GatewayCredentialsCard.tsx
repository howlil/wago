            ...
            <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto]">
              <div className="relative min-w-0">
                <input
                  ...
                  placeholder={adminPasswordConfigured ? "WAGO_ADMIN_PASSWORD" : "Configure WAGO_ADMIN_PASSWORD"}
                ...
                {signInCredential ? (
                  <button
                    ...
                    aria-label={showSignInCredential ? "Hide Admin password" : "Show Admin password"}
                  >
              ...
              <button
                ...
                type="button"
                onClick={onSignIn}
                disabled={isSigningIn || !adminPasswordConfigured}
              >
