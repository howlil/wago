...
export const translations = {
  en: {
    ...
    heroDescription: "A lightweight, self-hosted WhatsApp gateway built with Express, TypeScript, SQLite, React, and Baileys. Connect one account, expose a protected REST API, and keep operational state under your control.",
  ...
  id: {
    ...
    heroTitlePrefix: "Self-Hosted",
    heroTitleHighlight: "WhatsApp API Gateway",
    heroDescription: "Wago adalah gateway WhatsApp self-hosted yang ringan, dibangun dengan Express, TypeScript, SQLite, React, dan Baileys. Hubungkan satu akun, gunakan REST API terproteksi, dan simpan state operasional di infrastruktur Anda sendiri.",
